...
import com.example.fadhilikhsann.mysubmission3.favourite.FavouriteTvShowActivity;
...
public class TvShowFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvShowViewModel.getTvShow().observe(getActivity(), getTvShow);
        progressBar = view.findViewById(R.id.progressBar);


        tvShowViewModel.setTvShow(lang, "");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent goFav = new Intent(getActivity(), FavouriteTvShowActivity.class);
                startActivity(goFav);
            }
        });
    }
